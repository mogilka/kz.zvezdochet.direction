	...
	public void execute(@Active MPart activePart) {
		try {
			...
			String text = "Добрый день, " + event.getName() + ".\n\n"
				...
				+ "Формулировки не принимайте буквально, это скорей ассоциации, где верным может оказаться один вариант или все варианты.\n\n"
				+ "По событиям, которые совпали, добавьте пару слов, это мне поможет.\n\n";
			writer.append(text);
			writer.append(data);
			text = event.getName() + ", и ещё такой вопрос: опишите вкратце самые значительные, неординарные, переломные события вашей жизни и когда они произошли.\n\n"
				+ " Жду ваших ответов";
			writer.append(text);
			writer.close();
